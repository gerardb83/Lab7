...
public class Validations {
	...
	public static void main(String[] args) {
		...
		boolean validHtml = validateHtml(scnr, "Please enter an HTML element pair: "); 
	}
	...
	private static boolean validateHtml(Scanner scnr, String prompt) {
		boolean isValid = false;
		String input;
		do {
			System.out.print(prompt);
			input = scnr.nextLine();
			if (input.matches("\\<([a-zA-Z]{1}[\\w]*)\\>[\\s\\S]*\\<\\/\\1\\>")) {
				isValid = true;
				System.out.println("Valid entry");
			} else {
